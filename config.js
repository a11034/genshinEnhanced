...
export let configData = {
    ...
    customText:{
        fengshaA: "出牌阶段，对你攻击范围内的一名角色使用。其须使用一张【闪】，否则你对其造成1点风属性伤害，然后若其手牌数不小于体力值，其弃置所有手牌，反之强制翻面。",
        chenshaA:"出牌阶段，对你攻击范围内的一名角色使用。其须使用一张【闪】，否则你对其造成1点岩属性伤害，然后其减1点体力上限且随机废除一个未废除的装备栏。",
